        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="{{ asset('style/assets/img/products-02.jpg')}}" alt="..." />
        ...
        <section class="page-section">
            <div class="container">
                <div class="product-item">
                    ...
                    <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="{{ asset('style/assets/img/products-03.jpg')}}" alt="..." />
                    <div class="product-item-description d-flex me-auto">
